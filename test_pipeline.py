...
class ExperimentPipeline:
    def __init__(self, load_model_name: str = ""):
        ...
        self.model = load_trained_model(load_model_name, self.device)
        self.norm_stats = load_normalization(load_model_name, self.device)
    ...
    def run_single_experiment(
        ...
        histories = ExperimentHistory(truth=[], enkf=[], qpens=[], cnn=[], seed=seed)
        ...
        for i in range(num_inference_steps):
            ...
            histories.qpens.append(qpens_assimilated.copy())
    ...
    def _apply_cnn_correction(
        ...
        """Apply CNN correction to assimilated state"""
...
def run_pipeline(load_model_name: str = "") -> List[ExperimentHistory]:
...
def save_histories(
    ...
    save_path: str = "./out/experiment_histories.npz",
):
    save_data = {}
...
def load_histories(load_path: str) -> List[ExperimentHistory]:
